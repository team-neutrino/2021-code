...
public class GalBlueB extends SequentialCommandGroup
{
    Trajectory m_galBlueB = GalacticBBlueTrajectory.galBlueB;
    public GalBlueB(DriveSubsystem p_Drive, IntakePIDSubsystem p_Intake)
    {
        RamseteCommand redA = new RamseteCommand(m_galBlueB, p_Drive::getPose,
