...
public class TenBallAuton extends SequentialCommandGroup
{
    ...
    public TenBallAuton(DriveSubsystem p_Drive, IntakePIDSubsystem p_Intake, TurretSubsystem p_Turret,
            ShooterSubsystem p_Shooter, HopperSubsystem p_Hopper)
    {

        Trajectory m_tenBall0 = TenBallTrajectory.tenBall0;
        Trajectory m_tenBallHalf = TenBallTrajectory.tenBallHalf;
        Trajectory m_tenBallThird = TenBallTrajectory.tenBallThird;
        Trajectory m_tenBallBackward = TenBallTrajectory.tenBallBackward;
        Trajectory m_tenBall1 = TenBallTrajectory.tenBall1;
        // Trajectory m_tenBall2 = TenBallTrajectory.tenBall2;

        RamseteCommand tenBall0 = new RamseteCommand(m_tenBall0, p_Drive::getPose,
        ...
        RamseteCommand tenBallHalf = new RamseteCommand(m_tenBallHalf, p_Drive::getPose,
            new RamseteController(Constants.DriveConstants.K_RAMSETE_B, Constants.DriveConstants.K_RAMSETE_ZETA),
            new SimpleMotorFeedforward(Constants.DriveConstants.KS_VOLTS,
                Constants.DriveConstants.KV_VOLT_SECONDS_PER_METER,
                Constants.DriveConstants.KA_VOLT_SECONDS_SQUARED_PER_METER),
        ...
        RamseteCommand tenBallThird = new RamseteCommand(m_tenBallThird, p_Drive::getPose,
            new RamseteController(Constants.DriveConstants.K_RAMSETE_B, Constants.DriveConstants.K_RAMSETE_ZETA),
            new SimpleMotorFeedforward(Constants.DriveConstants.KS_VOLTS,
                Constants.DriveConstants.KV_VOLT_SECONDS_PER_METER,
                Constants.DriveConstants.KA_VOLT_SECONDS_SQUARED_PER_METER),
         ...
         RamseteCommand tenBallBackward = new RamseteCommand(m_tenBallBackward, p_Drive::getPose,
            new RamseteController(Constants.DriveConstants.K_RAMSETE_B, Constants.DriveConstants.K_RAMSETE_ZETA),
            new SimpleMotorFeedforward(Constants.DriveConstants.KS_VOLTS,
                Constants.DriveConstants.KV_VOLT_SECONDS_PER_METER,
                Constants.DriveConstants.KA_VOLT_SECONDS_SQUARED_PER_METER),
        ...
        RamseteCommand tenBall1 = new RamseteCommand(m_tenBall1, p_Drive::getPose,
            new RamseteController(Constants.DriveConstants.K_RAMSETE_B, Constants.DriveConstants.K_RAMSETE_ZETA),
            new SimpleMotorFeedforward(Constants.DriveConstants.KS_VOLTS,
                Constants.DriveConstants.KV_VOLT_SECONDS_PER_METER,
                Constants.DriveConstants.KA_VOLT_SECONDS_SQUARED_PER_METER),
        ...
        // RamseteCommand tenBall2 = new RamseteCommand(m_tenBall2, p_Drive::getPose,
        //     new RamseteController(Constants.DriveConstants.K_RAMSETE_B, Constants.DriveConstants.K_RAMSETE_ZETA),
        //     new SimpleMotorFeedforward(Constants.DriveConstants.KS_VOLTS,
        //         Constants.DriveConstants.KV_VOLT_SECONDS_PER_METER,
        //         Constants.DriveConstants.KA_VOLT_SECONDS_SQUARED_PER_METER),
        ...
        addCommands(new TurretSetAngleCommand(p_Turret, 70).alongWith(new InstantCommand(p_Turret::setLightOn),
            ...
            new SequentialCommandGroup(new InstantCommand(() -> p_Intake.setArmDown()),
                ...
                new InstantCommand(() -> p_Drive.tankDriveVolts(0, 0)), new ShootAuton(p_Shooter, p_Hopper, 4.5, 73000),
                tenBallThird, tenBallBackward, tenBall1, new InstantCommand(() -> p_Drive.tankDriveVolts(0, 0)),
