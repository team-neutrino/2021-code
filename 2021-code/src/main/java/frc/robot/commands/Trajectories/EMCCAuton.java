...
import frc.robot.Trajectories.EMCCTrajectory;
...
public class EMCCAuton extends SequentialCommandGroup
{
            ...
            ShooterSubsystem p_Shooter, HopperSubsystem p_Hopper)
    {
        ...
        Trajectory m_emcctraj = EMCCTrajectory.emcctraj;
        ...
        RamseteCommand emcctraj = new RamseteCommand(m_emcctraj, p_Drive::getPose,
        ...
        addCommands(new TurretSetAngleCommand(p_Turret, 70).alongWith(new InstantCommand(p_Turret::setLightOn),
            ...
            new SequentialCommandGroup(new InstantCommand(() -> p_Intake.setArmDown()),
                new ShootAuton(p_Shooter, p_Hopper, 3, 70000), emcctraj
                /*
                tenBallHalf,
