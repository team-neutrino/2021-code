...
public class SlalomTrajectory
{
    ...
    public static final Trajectory slalom0 = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)),
    ...
    public static final Trajectory slalom1 = TrajectoryGenerator.generateTrajectory(
    ...
    public static final Trajectory slalom2 = TrajectoryGenerator.generateTrajectory(
    ...
    public static final Trajectory slalom3 = TrajectoryGenerator.generateTrajectory(
