...
public class NeutrinoTrajectoryConfigs
{
    ...
    public static final TrajectoryConfig m_FastForwardConfig = new TrajectoryConfig(2.0, DriveConstants.K_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED).setKinematics(
        DriveConstants.K_DRIVE_KINEMATICS).addConstraint(m_autoVoltageConstraint);

    public static final TrajectoryConfig m_FastReverseConfig = new TrajectoryConfig(2.0, DriveConstants.K_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED).setKinematics(
        DriveConstants.K_DRIVE_KINEMATICS).addConstraint(m_autoVoltageConstraint).setReversed(true);
}
